...
package com.fcm.messaging.tester;
...
import com.fcm.messaging.tester.MainActivity;
import com.fcm.messaging.tester.R;
...
public class MainActivityEspressoTest {
    ...
    public void testSubscribeAndLog() throws InterruptedException {
        onView(ViewMatchers.withId(R.id.informationTextView)).check(matches(isDisplayed()));
